<template>
  <div>
          ...
          <v-tooltip right>
            <template v-slot:activator="{ on, attrs }">
              <v-icon
                ...
                v-on="on"
                class="mr-2"
                @click="rejectReversalICouncil(item)"
              >
                mdi-cancel
              </v-icon>
            </template>
    ...
    <Modal :modal="data.deletemodal" :width="480">
      <template v-slot:header>
        <ModalHeader :title="`Invoice Reversal Request `" />
      </template>
        ...
        <ModalBody>
          <v-form v-model="data.valid">
            ...
            <v-col class="pt-0 pl-6 pr-6 red--text" cols="12" md="12">
              Are you sure you want to send reversal request for this invoice?
            </v-col>
          </v-form>
        </ModalBody>
      </template>
          ...
          <div class="invoice-box" v-if="data.invoiceData">
            <td class="title">
              ...
              <v-btn
                ...
                text
                ><v-icon>mdi-arrow-u-left-top-bold</v-icon>Send Reverse
                Request</v-btn
              >
            </td>
            <div class="invoice-box" v-if="data.invoiceData">
