...
exports.useInvoiceDebtor = function () {
    ...
    var searchCategory = function (categoryName) {
        ...
        if (categoryName != null) {
            invoice_debtor_service_1.search({ name: categoryName.name }).then(function (response) {
    ...
    var remove = function () {
        ...
        invoice_debtor_service_1.destroy(data.itemtodelete).then(function () {
            reloadData();
            data.deletemodal = false;
        });
    };
    ...
    var updatecustomer = function (data) {
        invoice_debtor_service_1.update(data).then(function (response) {
    ...
    var createCustomer = function (data) {
        invoice_debtor_service_1.create(data).then(function (response) {
