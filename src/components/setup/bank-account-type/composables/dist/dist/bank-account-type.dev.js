...
exports.useBankAccountType = function () {
  ...
  var initialize = function initialize() {
    banck_account_types_service_1.get({
      per_page: 10
  ...
  var searchCategory = function searchCategory(categoryName) {
    if (categoryName != null) {
      banck_account_types_service_1.search({
  ...
  var deleteBankAccountType = function deleteBankAccountType(deleteId) {
  ...
  var loadGfsCodes = function loadGfsCodes() {
