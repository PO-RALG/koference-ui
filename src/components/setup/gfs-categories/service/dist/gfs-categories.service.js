...
var get = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].get("/api/v1/gfs-categories", payload)];
...
var find = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].get("/api/v1/gfs-categories/" + id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var create = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].post("/api/v1/gfs-categories", payload)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var update = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].put("/api/v1/gfs-categories/" + payload.id, payload)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"]["delete"]("/api/v1/gfs-categories/" + payload)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
